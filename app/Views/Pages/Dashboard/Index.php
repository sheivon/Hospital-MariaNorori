<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div>
      <h2 class="mb-0"><i class="fa-solid fa-chart-line me-2"></i><span data-i18n="dashboard">Dashboard</span></h2>
      <p class="text-muted mb-0" data-i18n="dashboard_subtitle">Hospital statistics overview</p>
    </div>
  </div>
...
(function(){
  ...
  async function loadStats(){
    try {
      ...
      if (!res.ok) {
        setError(`Dashboard API failed (${res.status})`);
        return;
      }
      ...
      if (!patientsCtx || !encountersCtx || !diagnosesCtx || !doctorCtx) {
        setError('Dashboard chart containers are missing');
        return;
      }
