...
<div class="container mt-4" id="vitalsPage">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex align-items-center gap-2">
      <input type="search" id="vitalsSearch" class="form-control form-control-sm" placeholder="Searchâ€¦" style="min-width:200px">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="vitalForm" class="row g-3">
          ...
          <div class="col-md-4">
            <label for="vitalTemp" class="form-label" data-i18n="vitals_temperature">Temperature (Â°C)</label>
          ...
          <div class="col-md-3">
            <label for="vitalSpO2" class="form-label" data-i18n="vitals_oxygen_saturation">SpOâ‚‚ (%)</label>
      ...
      <div class="modal-footer">
        ...
        <button id="btnSaveVital" class="btn btn-primary" type="button" form="vitalForm" data-modal-save>
...
(function(){
    ...
    if (encounterSelect){
      encounterSelect.innerHTML = `<option value="" data-i18n="select_encounter">${escapeHtml(t('select_encounter') || '-- None --')}</option>` +
        encountersData.map(e => {
          ...
          return `<option value="${encodeURIComponent(e.id)}">#${e.id} Â· ${escapeHtml(when)} Â· ${escapeHtml(e.encounter_type || '')}</option>`;
        }).join('');
    }
  ...
  // Refresh the DataTable in place after CRUD â€” avoids touching innerHTML
  ...
  async function submitForm(){
    ...
    try {
      ...
      resetForm();
      await loadVitals();
      await window.ModalSaveState?.finish(form, t('vitals_saved') || 'Vitals saved', 'success');
    } catch (e) {
      const message = e.message || (t('error') || 'Error');
      setAlert(message);
      await window.ModalSaveState?.finish(form, message, 'error');
    }
  }
