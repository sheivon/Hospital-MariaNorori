<div class="container mt-4" id="childFollowupsPage">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div>
      <h2 class="mb-0"><i class="fa-solid fa-child me-2"></i><span data-i18n="child_followups_page_title">Seguimiento Integral NiÃ±ez y Adolescencia</span></h2>
      <p class="text-muted mb-0" data-i18n="child_followups_page_description">Registro rÃ¡pido de signos clÃ­nicos, nutriciÃ³n y entorno familiar.</p>
    </div>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="table-responsive">
        <table id="childFollowupsTable" class="table table-sm table-bordered table-striped align-middle w-100 dt-container">
          <thead>
            <tr>
              <th>#</th>
              <th data-i18n="patient">Paciente</th>
              <th data-i18n="cedula">CÃ©dula</th>
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div data-age-band-banner class="alert alert-warning d-none mb-3"></div>
        <form id="childFollowupsForm" data-age-band-allowed="ninez">
          ...
          <div class="mb-3">
            ...
            <div class="row g-2">
              <div class="col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="respira_rapida" name="respira_rapida" value="1"><label class="form-check-label" for="respira_rapida" data-i18n="child_followup_sign_rapid_breathing">Respira rÃ¡pida</label></div></div>
          ...
          <div class="mb-3 row">
          <div class="col-6">
            <label class="form-label" data-i18n="child_followups_nutrition">NutriciÃ³n</label>
            <div class="row g-2">
              ...
              <div class="col-md-4"><div class="form-check mt-2"><input class="form-check-input" type="checkbox" id="malnutricion" name="malnutricion" value="1"><label class="form-check-label" for="malnutricion" data-i18n="child_followup_malnutrition">MalnutriciÃ³n</label></div></div>
            </div>
          </div>
          ...
          <div class="mb-3 row "> 
            <div class="col-4">
              ...
              <div class="col-3">
                <label for="relacion_afectivo" class="form-label" data-i18n="child_followup_affective_relationship">RelaciÃ³n afectiva</label>
      ...
      <div class="modal-body">
        ...
        <form id="childFollowupNotesForm">
          <div class="mb-3">
            ...
            <input type="text" id="childFollowupNoteTipo" name="tipo" class="form-control" placeholder="Ej. ObservaciÃ³n" data-i18n-placeholder="child_followup_note_type_placeholder" />
          </div>
          <div class="mb-3">
