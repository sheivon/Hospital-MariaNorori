  ...
  <div class="modal-body">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
        ...
        <select class="form-select" name="role" id="role" aria-describedby="roleHelp"></select>
        <small id="roleHelp" class="text-muted d-block mt-1" data-i18n="role_catalog_hint">
          Roles come from the read-only user_roles catalog
        </small>
      </div>
