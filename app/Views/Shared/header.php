...
<head>
  ...
  <?php
    ...
    $needsDataTablesCSS = in_array($currentPage, [
      'patient-allergies.php', 'medications.php', 'encounters.php',
      'diagnostics.php', 'seguimiento-pediatric.php', 'treatments.php',
      'vitals.php', 'patients.php', 'appointments.php', 'users.php'
    ]);
  ?>
  <?php if ($needsDataTablesCSS): ?>
