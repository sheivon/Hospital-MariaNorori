...
class DiagnosticoRepository extends \App\Repositories\BaseRepository implements RepositoryInterface
{
    ...
    public function create(array $data): int
    {
        $stmt = $this->pdo->prepare(
            'INSERT INTO diagnostics (patient_id, encounter_id, type, unit, room, icd10_code, description, status, severity, date, time, plan, weight, height, inss_no, created_by)
             VALUES (:patient_id, :encounter_id, :type, :unit, :room, :icd10_code, :description, :status, :severity, :date, :time, :plan, :weight, :height, :inss_no, :created_by)'
        );
    ...
    public function update(int $id, array $data): bool
    {
        $sql = 'UPDATE diagnostics SET patient_id = :patient_id, encounter_id = :encounter_id, type = :type, unit = :unit, room = :room, icd10_code = :icd10_code,
             ...
             height = :height, inss_no = :inss_no, updated_by = :updated_by
             WHERE id = :id';
