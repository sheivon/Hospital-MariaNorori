...
use App\Controllers\Pages\SetupPageController;

['message' => $message, 'posted' => $posted, 'mysqlExtensionsLoaded' => $mysqlExtensionsLoaded] =
    SetupPageController::viewModel($_POST, $_SERVER['REQUEST_METHOD'] ?? 'GET');
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 btn-group mb-3 d-flex gap-2">
                        <button type="submit" name="test_connection" class="btn btn-sm btn-outline-primary">Test connection</button>
                        <button type="submit" name="save_config" class="btn btn-sm btn-outline-success">Save to .env</button>
                    </div>
                </div>
            </div>
        </div>

    <div class="d-inline-flex gap-1 mt-0">
