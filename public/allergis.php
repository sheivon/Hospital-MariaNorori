...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div>
      <h2 class="mb-0"><i class="fa-solid fa-allergies me-2"></i>Patient Allergies</h2>
      <p class="text-muted mb-0">Create, update, and manage patient allergy records.</p>
    </div>
    <button id="btnAddAllergy" type="button" class="btn btn-success"><i class="fa-solid fa-plus me-1"></i>Add Allergy</button>
  </div>
...
(function(){
  ...
  function resetForm() {
    ...
    document.getElementById('allergyModalLabel').textContent = 'Add Allergy';
  }
  ...
  window.editAllergy = async function(id) {
    ...
    try {
      ...
      document.getElementById('allergyModalLabel').textContent = 'Edit Allergy';
      allergyModal.show();
    } catch (err) {
      showAlert(err.message);
    }
